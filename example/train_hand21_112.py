...
from core.imdb_hand21 import IMDB
from train_hand21 import train_net
from core.symbol import L21_Net112
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train L21_Net112',
    ...
    parser.add_argument('--prefix', dest='prefix', help='new model prefix',
                        default='model/lnet21_112', type=str)
...
if __name__ == '__main__':
    ...
    train_L_net(args.image_set, args.root_path, args.dataset_path, args.prefix,
